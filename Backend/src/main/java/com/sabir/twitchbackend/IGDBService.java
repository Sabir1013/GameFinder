...
public class IGDBService {
    ...
    public String getGamesPage(int offset) {
        String body = String.format("fields name, first_release_date, parent_game.name, screenshots.url, game_type, cover.url, rating, summary, storyline; where game_type = (0,1,10,14) & cover.url != null; limit 500; offset %d;", offset);
